  ...
  return (
    <div className='w-90 md:w-120 h-100 mx-auto mt-30 shadow-lg rounded-lg bg-orange-100'>
      ...
      <form className='flex flex-col items-center mt-10'>
        <input type="text" placeholder='Gmail & Number' className='border border-gray-300 rounded-lg p-2 mb-4 w-80 md:w-90 bg-white'
         value={input}
        ...
        <button  onClick={handleSubmit} className='bg-blue-500 text-white px-34 md:px-39 py-2 rounded-lg' id='login'>Log In</button>
