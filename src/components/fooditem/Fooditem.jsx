...
const Fooditem = ({ id, name, price, description, image }) => {
  ...
  return (
    <div className='shadow-xl xl:w-80 lg:mx-0 transition delay-150 duration-200 ease-in-out hover:-translate-y-1 hover:scale-110 lg:w-67 sm:mx-25'>
      <div  >
        ...
        <div className='p-4 flex align-center gap-x-2 '>
          ...
          <p className='text-lg text-center'>{cartItem[id]}</p>
