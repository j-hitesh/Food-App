...
const Header = () => {
  ...
  return (
    <div className='flex justify-between w-full bg-gray-700  text-white p-4'>
      ...
      <ul className="flex gap-x-12  w-1/2 text-md lg:text-2xl">
      ...
      <div className='flex gap-x-4'>
        <button className='bg-red-500 px-3 py-2 rounded-xl text-xs xl:text-2xl hover:text-red-500 hover:bg-blue-400'>Sign-up</button>
        <button className='bg-red-500 px-3 py-2 rounded-xl text-xs xl:text-2xl hover:text-red-500 hover:bg-blue-400'>Log-in</button>
      </div>
    </div>
  );
};
