...
const Header = () => {
  ...
  return (
    <div className='flex justify-between w-full bg-gray-700  text-white px-4 py-4 rounded-b-lg fixed top-0 z-10 mb-10'>
       {/* <h1 className='bg-pink-500'>check tailwind</h1> */}
      {/* <img  src={assets.logo} alt="logo" className="w-12" /> */}
      <ul className="flex gap-x-12  w-1/2 text-md lg:text-2xl sm:text-xl">
